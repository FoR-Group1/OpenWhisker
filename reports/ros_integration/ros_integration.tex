...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/filtered_magnetometer.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/corrected_derivative.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/x_y_relationship.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/polynomial_regression.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/pteg_episodes.png}
    \caption{Corrected \(\dot{y}\) of the Isolated Contact Episodes. Each episode is 1 line and the color corresponds to the distance from the base of the whisker \(x\) where contact is made}
